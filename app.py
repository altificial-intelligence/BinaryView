...
def classify():
    ...
    # encode image url as ascii since this is required
    firstImage = urls[0].encode('ascii', errors='backslashreplace')
    print type(firstImage), firstImage, repr(firstImage)
